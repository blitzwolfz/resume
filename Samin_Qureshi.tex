\documentclass[letterpaper]{article} % Change from a4paper to letterpaper
...
George Brown College - Toronto, ON \hfill Jan 2024 - Present \\
\vspace{4mm}
\vspace{1mm}
...
\textbf{Backend Developer} \hfill Aug 2024 - Nov 2024\\
\textit{Paulos Poetry} \hfill Toronto, Ontario\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Spearheaded the development and implementation of the complete backend including MongoDB and NodeJS.
    \item Enabled a 20\% increase in poem submission speed through Express API optimizations.
    \item Boosted content delivery efficiency by doubling performance.
\end{itemize}
% \textbf{Backend Developer} \hfill Feb 2023 - Aug 2023\\
% \textit{Rack I} \hfill Toronto, Ontario\\
% \vspace{-1mm}
% \begin{itemize} \itemsep 1pt
%     \item Designed and implemented robust backend systems tailored to client needs across diverse projects.
%     \item Collaborated with clients to define project goals, ensuring alignment with business objectives.
%     \item Resolved complex technical challenges, ensuring seamless project delivery on time.
% \end{itemize}
\textbf{Backend Developer} \hfill Feb 2023 - Aug 2023\\
\textit{Rack-I} \hfill Toronto, Ontario\\
\vspace{-1mm}
...
\end{itemize}
\textbf{Hardware \& Software Analyst Intern} \hfill Sept 2022 - April 2023\\
\textit{Toronto Metropolitan University} \hfill Toronto, Ontario\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
...
% {\textbf{Meme Royale}} \\
% \textbf{Technologies:} \textit{TypeScript, JavaScript, MongoDB, JSON} \\
...
% \vspace*{3mm}
{\textbf{Pokedex}} \\ 
\textbf{Technologies:} \textit{TypeScript, JavaScript, HTML, Axios, Tailwind CSS, Vite} \\
